...
元々は[titan823氏の派生版](https://github.com/titan823/geminipwa)を便利に使っていたのですが、個別のシステムプロンプトが廃止されるに至って、自分好みのものを製作しました。
...
* **プロンプト確認**
  実際にGemini APIに送信されたプロンプトを閲覧できます。
...
* **セックス関連コンテンツの警告表示**
  モデルからの返答に性的コンテンツが含まれる場合、ピンク枠で警告度を表示します。
